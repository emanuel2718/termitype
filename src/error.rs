...
pub enum AppError {
    ...
    TypingTestNotInProgress,
    TypingTestAlreadyCompleted,
    InvalidCharacterPosition,
    IllegalBackspace,
    IllegalSpaceCharacter,
    TermiDB(String),
...
impl std::fmt::Display for AppError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::TypingTestNotInProgress => write!(f, "Typing test not in progress."),
            Self::TypingTestAlreadyCompleted => write!(f, "Typing is already completed."),
            Self::InvalidCharacterPosition => write!(f, "Invalid character position."),
            Self::IllegalBackspace => write!(f, "Cannot backspace at current location"),
            Self::IllegalSpaceCharacter => write!(f, "Cannot type <Space> at current location"),
