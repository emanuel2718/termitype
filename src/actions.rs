...
pub fn handle_action(app: &mut App, action: Action) -> Result<(), AppError> {
    match action {
        ...
        Action::CommandPaletteToggle => app.handle_command_palette_toggle(),
        ...
        Action::LeaderboardOpen => app.handle_leaderboard_open(),
        Action::LeaderboardClose => app.handle_leaderboard_close(),
        Action::LeaderboardToggle => app.handle_leaderboard_toggle(),
        Action::LeaderboardSort(col) => app.handle_leaderboard_sort(col),
        Action::LeaderboardNav(motion) => app.handle_leaderboard_nav(motion),
        Action::Toggle(setting) => app.handle_toggle_setting(setting),
        Action::Enable(setting) => app.handle_enable_setting(setting),
        Action::Disable(setting) => app.handle_disable_setting(setting),
